...
static void mac_send_desc_init(mac_t *mac)
{
    ...
    {
        ((desc_t *)addr)->tdes0 = 0;
        ((desc_t *)addr)->tdes1 = 0 | (1 << 24)  | (1<<30) | (1<<29) |(BUFFSIZE & 0x7ff);
    ...
    ((desc_t *)addr)->tdes0 = 0;
    ((desc_t *)addr)->tdes1 = 0 | (1 << 25)  |  (1<<30) | (1<<29) |(BUFFSIZE & 0x7ff);
    ((desc_t *)addr)->tdes2 = TxBuff& 0x1fffffff;
...
static void mac_recv_desc_init(mac_t *mac)
{
    ...
    {
        ((desc_t *)addr)->tdes0 = 0;
        ((desc_t *)addr)->tdes1 = 0 | (1 << 24)  | (BUFFSIZE & 0x7ff);
    ...
    ((desc_t *)addr)->tdes0 = 0;
    ((desc_t *)addr)->tdes1 = 0 | (1 << 25)  | (BUFFSIZE & 0x7ff);
    ((desc_t *)addr)->tdes2 = RxBuff & 0x1fffffff;
...
void mac_recv_task()
{
    ...
    while(1){
        ...
        printf("> [MAC RECV TASK] Finished!\n");
        desc_t *recv_des = (desc_t *)test_mac.rd;
        for(i = 0; i < 64; i++)
